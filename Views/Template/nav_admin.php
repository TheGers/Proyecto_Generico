    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <!-- -----------------------------------TIENDA------------------------------- -->
            <?php if (!empty($_SESSION['permisos'][2]['r']) || !empty($_SESSION['permisos'][2]['r'])) { ?>
                <li class="treeview">
                    <a class="app-menu__item" href="#" data-toggle="treeview">
            ...
            <?php if (!empty($_SESSION['permisos'][2]['r']) || !empty($_SESSION['permisos'][2]['r'])) { ?>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <?php if (!empty($_SESSION['permisos'][2]['r'])) { ?>
                            <li><a class="treeview-item" href="<?= base_url(); ?>/compras"><i class="icon fa fa-circle-o"></i> Nueva Compra</a></li>
                        <?php } ?>

                        <li><a class="treeview-item" href="<?= base_url(); ?>/indexcompras"><i class="icon fa fa-circle-o"></i> Compras TV</a></li>
                    </ul>
                </li>
                <?php } ?>
